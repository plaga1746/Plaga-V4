-- Este archivo contiene el script proveniente de: https://pastebin.com/8KLiBHue

-- Pega aquí el contenido si lo tienes localmente.
...
-- Create Main Window
local window = library:AddWindow("NOVA HUB V4", {
    main_color = Color3.fromRGB(244, 194, 194),
...
mainTab:AddLabel("BLX_Encrypted Next Time ask for Help")
    ...
    task.spawn(function()
        while getgenv().autoFarm do
            ...
            if game:GetService("Players").LocalPlayer.Durability.Value >= 100 then
                for i, v in pairs(game:GetService("Workspace").machinesFolder:GetDescendants()) do
                    if v.Name == "neededDurability" and v.Value == 100 and game.Players.LocalPlayer.Character:FindFirst
